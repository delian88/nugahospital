        ...
        <div className="hidden md:flex items-center space-x-10">
          {navLinks.map((link) => (
            <button
              ...
              className={`font-black text-sm uppercase tracking-widest font-modern transition-all relative group ${
                currentView === link.id 
                  ? 'text-primary' 
          ...
          <button 
            ...
            className="bg-primary text-white px-8 py-3 rounded-2xl font-black text-sm uppercase tracking-widest font-modern hover:bg-primary-dark transition-all transform hover:scale-105 active:scale-95 shadow-2xl shadow-primary/30"
          >
            Book Appointment
          </button>
        </div>
